 ...
 * TODO 这个就是客户端前端代码，就是入口，去找main方法
 */
public class CliFrontend {
	...
	// TODO 第一个参数是默认配置，第二个参数是命令行配置（自己写的）
	...
	public static void main(final String[] args) {
		...
		// 如果standalone启动就先用standalone，如果yarn启动就用yarn，如果都不是就用默认的
		// bin/flink run -t yarn-per-job /opt/module/flink-1.12.2/examples/streaming/SocketWindowWordCount.jar --port 9999
