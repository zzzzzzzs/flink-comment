...
public class YarnClusterDescriptor implements ClusterDescriptor<ApplicationId> {
	...
	private ApplicationReport startAppMaster(
		...
		* */
		...
		/*TODO 创建Map，用来存储 ApplicationMaster 的环境变量和类路径*/
		...
		/*TODO 将之前封装的 Map（AM的环境信息、类路径），设置到容器container里*/
		...
		/*TODO 前面做了很多上传、环境配置，终于可以提交应用了，yarn的源码*/
